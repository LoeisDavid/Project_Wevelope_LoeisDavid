          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img src="<?= BASE_URL ?>/pages/html/img/profile.png" class="user-image rounded-circle shadow" alt="User Image">
                <span class="d-none d-md-inline">Loeis David</span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                <!--begin::User Image-->
                <li class="user-header text-bg-primary">
                  <img src="<?= BASE_URL ?>/pages/html/img/profile.png" class="rounded-circle shadow" alt="User Image">
                  <p>
                    Loeis David
