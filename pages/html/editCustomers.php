...
<?php if (isset($_SESSION['alert_delete'])): ?>
  ...
  <form method="post" action="../../Control/Control.php?type=customer&action=update">
    ...
    <d<button type="submit" class="btn btn-primary w-100 mt-3" style="display:block;">Simpan Perubahan</button>
<a href="tableItemInv.php" class="btn btn-secondary w-100 mt-2" style="display:block;">Cancel</a>
